        ...
        <div className='grid grid-cols-1 items-center gap-14 lg:grid-cols-2'>
          ...
          <div className='max-w-xl'>
            <h1 className='text-4xl font-semibold tracking-tight lg:pr-10 lg:text-[52px]/[60px]'>
              Join the Sharkdom Partnerships Talent Network
            </h1>
            <p className='mt-4 max-w-[500px] text-lg leading-[28px] text-[#101828C9]'>
              Get discovered by companies building partner programs and
              ecosystems across SaaS, cloud and GTM teams.
            </p>
          ...
          <div className='relative hidden lg:block'>
            <div
              ...
              style={{
                backgroundImage: "url('/assets/partnership-jobs-hero4.svg')"
              }}
            />
          </div>
        </div>
