...
export const metadata: Metadata = {
  title: `Sharkdom Onboarding Demo | Register | Sharkdom Onboarding | Register | Modern day partner ops platform`,
  description:
    'Grow your brand using Go-To-Market platform. Signup to Sharkdom today and find out how easy it is to find Ideal Partners for your businessess using AI'
}
