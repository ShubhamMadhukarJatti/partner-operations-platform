...
export type VideoPlayerThumbnailProps = ComponentProps<
...
export const VideoPlayerThumbnail = ({
  ...
  <MediaPreviewThumbnail className={cn(className)} {...props} />
)

export type VideoPlayerPosterImageProps = ComponentProps<
  typeof MediaPosterImage
>

export const VideoPlayerPosterImage = ({
  className,
  ...props
}: VideoPlayerPosterImageProps) => (
  <MediaPosterImage className={cn(className)} {...props} />
)
