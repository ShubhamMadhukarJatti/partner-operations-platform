...
const ResellDealNotPresentPlaceholder = () => {
    ...
    <div className='flex max-w-[800px] flex-col items-center justify-center'>
      ...
      <div className='text-center'>
        <h3 className='mb-2 text-xl font-bold text-gray-900'>
          Purchase licenses at huge discount
        </h3>
        ...
        >
          <Plus size={18} className='mr-2' /> Request for Licences
        </Button>
      </div>
    </div>
  )
...
export default ResellDealNotPresentPlaceholder
