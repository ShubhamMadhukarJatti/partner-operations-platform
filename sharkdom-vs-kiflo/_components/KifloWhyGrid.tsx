...
const CARDS = [
  {
    ...
    lines: [
      ...
      'single week not a 6-month implementation',
      'project.'
    ]
  },
  {
  ...
  },
  {
    ...
    lines: [
      'Allocate permission of specific partners to your internal team with real time logs.'
    ]
  },
  {
    n: '04',
...
export default function KifloWhyGrid() {
  return (
    <section className='bg-white py-16 md:py-24'>
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        ...
        <p className='mx-auto mt-6 max-w-3xl text-center text-[16.5px] leading-relaxed text-[#3e424d]'>
          ...
          product from
          <br className='hidden sm:block' /> Crossbeam or Partnerstack.
        </p>
