...
const FieldMapping = ({
  ...
  return (
    <div className='mt-8 w-full'>
      ...
      <div>
        <h3 className='fds-text-lead-semibold text-text-100'>Field mapping</h3>
      ...
      <div className=' mb-6 mt-1 bg-[#FDF3E3] p-4'>
        <h3 className='fds-text-semibold text-text-100'>
      ...
      <Button
        variant={!isAllFieldsMapped ? 'disable' : 'primary'}
        className={cn(
