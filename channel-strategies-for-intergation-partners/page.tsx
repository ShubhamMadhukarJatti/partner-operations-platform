...
function ChannelStrategiesForIntegrationPartnersPage() {
  return (
    <div className='min-h-screen w-full'>
      ...
      <MeetOurSpeaker
        ...
        imageSrc={{ src: '/events/event_meet2.svg', linkdirect: '#' }}
...
export default ChannelStrategiesForIntegrationPartnersPage
