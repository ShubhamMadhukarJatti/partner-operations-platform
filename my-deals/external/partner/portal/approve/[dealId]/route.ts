...
/**
 * PATCH /api/my-deals/external/partner/portal/approve/[dealId]?isApproved=...&dealProtectionPeriod=...&integrationType=...
...
export async function PATCH(
  ...
  try {
    ...
    const path = `/my-deals/external/partner/portal/approve/${encodeURIComponent(dealId)}?isApproved=${encodeURIComponent(isApproved)}&dealProtectionPeriod=${encodeURIComponent(dealProtectionPeriod)}&integrationType=${encodeURIComponent(integrationType)}`
