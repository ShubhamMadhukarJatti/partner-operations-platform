...
import { getLibraryBlogs } from '@/lib/db/sanity-cms'
...
export default async function LibraryPage() {
  ...
  return (
    <>
      ...
      <div id='library' className='container flex flex-col items-center py-12'>
        ...
        <section className='grid gap-12 sm:grid-cols-2 sm:px-20'>
          {posts.map((post, index) => {
            ...
            return (
              ...
              >
                <div
                  className='relative h-60 rounded-t-2xl sm:sm:h-[500px]'
                  style={postStyle}
                >
                  <Image
