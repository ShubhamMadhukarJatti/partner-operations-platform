export const compabilityModelPrompt = `You will be provided with input about two startups, including the following details: - ABOUT: Description of the startup.
