  ...
  return (
    <div className='flex h-full min-h-screen justify-center'>
      <div className='flex h-screen w-full flex-col bg-white'>
            ...
            <div className='flex w-full flex-col justify-center text-center md:w-3/4 lg:w-1/2'>
              <div className='flex justify-between pb-4'>
                <Image
                  ...
                  width={100}
                />
                <p className='text-xs text-[#717182]'>Step {stepCount} of 10</p>
              </div>
        ...
        {/* Scrollable content */}
        <div className='flex-1 overflow-y-auto pt-24 2xl:pt-4'>
          <div className='flex h-full items-center justify-center'>
            <div className='mt-6 w-full px-4 lg:px-1'>{children}</div>
          </div>
        </div>
      </div>
