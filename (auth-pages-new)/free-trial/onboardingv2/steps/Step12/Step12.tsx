...
import { step12 } from '../../constants/constants'
import { StateType, StepOption } from '../../types/types'
import { updateSelection, updateStepSelection } from '../../Util/util'

interface Step12Props {
  onChange: (value: boolean) => void
  data: StateType['avoidFundraisingCompany']
}

export const Step12: FC<Step12Props> = ({ onChange, data }) => {
  const [steps, updateStepsHandler] = useState<StepOption[]>(step12)
  ...
  useEffect(() => {
    updateStepsHandler(updateSelection(data, step12))
  }, [data])
  ...
  return (
    <>
      <SectionHeader
        ...
        subtitle='Do you want to avoid fundraising companies?'
      />
