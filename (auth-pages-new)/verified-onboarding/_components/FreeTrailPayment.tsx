          ...
          <div className='flex h-full w-full flex-col justify-between rounded-[20px] border border-[#E4E7EE] bg-[#F8FBFF] text-black  shadow-lg lg:col-span-2 lg:w-[450px] '>
            <div>
              <div className='flex flex-col justify-between gap-2 rounded-tl-[20px] rounded-tr-[20px] bg-[#F2F5FD] p-6 text-left'>
                <h3 className='fds-heading flex items-center gap-4 text-text-100'>
                  STANDARD
                  <span className='fds-text-sm rounded-md bg-semantic-caution px-2  py-1 text-text-100'>
                    FREE TRIAL
                  </span>
                </h3>
                ...
                <div className='mt-6 flex items-center gap-3'>
                  ...
                  <p className='fds-heading flex items-center gap-4 text-text-100'>
                    {country === 'IN' ? '₹' : '$'}
                    {standardPricing}
                    <p className='fds-text-semibold flex items-baseline text-[#488D12]'>
            ...
            <div className='flex justify-center px-6 pb-6'>
              <Button
                className='text-[#0062F1 fds-text-semibold w-full rounded-lg border border-[#ADB7CB] bg-transparent text-[#3E50F7] hover:text-white'
                loading={
                ...
                <div className='mt-6 flex items-center gap-3'>
                  ...
                  <p className='fds-heading flex items-center gap-4 text-text-100'>
                    <span>
                      ...
                      <span className='fds-text text-[#252424]'>/month</span>
                    </span>
                    <p className='fds-text-semibold flex items-baseline text-[#488D12]'>
                      {premiumDiscount}% off
                    </p>
