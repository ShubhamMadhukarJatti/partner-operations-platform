...
const NewOnboardingFlow = (props: Props) => {
  ...
  return (
    <div className='flex'>
      <div className=' flex w-full flex-1  justify-end overflow-hidden'>
      ...
      <OnboardingRight
        ...
        imageSrc={steps[step - 1].imageSrc}
        imgWidth={steps[step - 1].imgWidth}
        imgHeight={steps[step - 1].imgHeight}
        isFree
      />
    </div>
  )
