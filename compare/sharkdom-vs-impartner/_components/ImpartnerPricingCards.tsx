...
const IMPARTNER_ITEMS = [
  { ok: false as const, label: 'No free trial' },
  { ok: true as const, label: 'Velocity onboarding' },
  { ok: false as const, label: 'CRM integration add-on fees' },
  { ok: false as const, label: 'No starter/free tier' }
]

const SHARKDOM_ITEMS = [
  'Free 14-day trial & starter tier',
  'Flat pricing structure',
  'Native LMS with quizzes + auto-approval',
  'Unlimited partners & CRM integrations'
]

export default function ImpartnerPricingCards() {
  return (
      ...
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        <header className='mx-auto flex max-w-4xl flex-col items-center text-center'>
          ...
          <p className='mt-6 max-w-xl text-pretty text-base font-normal leading-relaxed text-[#6b7280] md:max-w-[36rem] md:text-[17px] md:leading-[26px]'>
            Impartner requires heavy enterprise commits and custom quotes
            starting around $2,000/mo. Sharkdom offers flat, transparent billing
