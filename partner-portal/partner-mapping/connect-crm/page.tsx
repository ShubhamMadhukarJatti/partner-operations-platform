...
export default function PartnerPortalConnectCrmPage() {
  ...
  useEffect(() => {
    ...
    if (stored) {
      router.replace(`/partner-portal/partner-mapping/${stored}/connect-crm`)
    }
  }, [router])
...
Katylyst,https://katylyst.com,23900,IN,Internet & Technology,karti@katylyst.com,2025-09-14`
  ...
  const handleNext = () => {
    if (!selected) return
    const base = '/partner-portal/partner-mapping'
    if (selected === 'hubspot') {
      router.push(`${base}/connect-service/hubspot`)
    } else if (selected === 'zoho') {
      router.push(`${base}/connect-service/zoho`)
          ...
          <>
            ...
            <div className='sticky bottom-0 w-full'>
              <div className='flex w-full items-center justify-between border-t border-[#E4E7EE] bg-white py-4 md:px-4'>
                <Link
                  href='/partner-portal/partner-mapping'
