...
/**
 * GET /api/partner-portal/salesforce/contacts?userId=&fields=Name,Email...
 * Partner portal: Salesforce contacts by userId. Proxies via fetcher.
 */
export async function GET(request: NextRequest) {
  try {
    ...
    const path = `/integration/salesforce/contacts${queryString}`
