...
/**
 * GET /api/partner-portal/salesforce/contacts/describe?userId=
 * Partner portal: Salesforce Contact describe (fields) by userId. Proxies via fetcher.
 */
export async function GET(request: NextRequest) {
  try {
    ...
    const path = `/integration/salesforce/contacts/describe?userId=${encodeURIComponent(userId)}`
