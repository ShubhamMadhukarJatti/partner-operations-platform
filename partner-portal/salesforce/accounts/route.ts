...
/**
 * GET /api/partner-portal/salesforce/accounts?userId=&fields=Name,Industry...
 * Partner portal: Salesforce accounts by userId. Proxies via fetcher.
 */
export async function GET(request: NextRequest) {
  try {
    ...
    const path = `/integration/salesforce/accounts${queryString}`
