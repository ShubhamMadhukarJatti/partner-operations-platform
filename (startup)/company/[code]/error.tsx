...
export default function Error({
  ...
  const url = `mailto:support@sharkdom.com?subject=Error%20Report&body=${error.message} ${error.digest && error.digest} on startup page`
  ...
  return (
    <main className='flex h-full w-full items-center justify-center'>
      <div className='flex flex-col items-center justify-center gap-4 rounded-xl border-2 border-red-400 bg-red-50 p-4'>
        ...
        <p>
          You will be automatically redirected to the explore page in 5 seconds.
        </p>
      </div>
    </main>
  )
