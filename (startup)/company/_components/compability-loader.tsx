...
export function CompabilityLoader({ orgName }: { orgName: string }) {
  return (
    <Card className=''>
      <CardSkeletonContainer>
        <Skeleton />
      </CardSkeletonContainer>
      <CardDescription className='-mt-6 text-center text-muted-foreground'>
        Generating your compabilty with {orgName}
      </CardDescription>
    </Card>
  )
}
...
const Skeleton = () => {
  ...
  return (
    <div className='relative flex h-full items-center justify-center overflow-hidden p-8'>
      <div className='flex flex-shrink-0 flex-row items-center justify-center gap-2'>
        ...
        <Container className='circle-2 h-12 w-12'>
          <Image
            ...
            height={48}
            width={48}
            alt='loader-icon w-full h-full'
          />
        </Container>
        <Container className='circle-3 h-12 w-12'>
          <Image
            src='/ai-loader-1.svg'
            height={48}
            width={48}
      ...
      {/* TODO Find solution for this in tailwind css */}
      ...
      <div
        style={{ animation: 'move 5s linear infinite' }}
        className=' absolute top-20 z-40 m-auto h-40 w-px bg-gradient-to-b from-transparent via-cyan-500 to-transparent'
      >
...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        'group mx-auto w-full max-w-sm rounded-md border border-[rgba(255,255,255,0.10)] bg-gray-100 p-8 shadow-[2px_4px_16px_0px_rgba(248,248,248,0.06)_inset] dark:bg-[rgba(40,40,40,0.70)]',
        className
      )}
    >
      {children}
