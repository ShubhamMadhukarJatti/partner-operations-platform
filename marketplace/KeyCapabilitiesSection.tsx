...
import { LayoutGrid, LayoutPanelLeft, Link2, Route, Search } from 'lucide-react'
      ...
      <div className='max-w-8xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='mx-auto mb-20 max-w-5xl text-center'>
          ...
          <h2 className='mb-6 text-4xl font-semibold leading-tight text-gray-900 lg:text-[60px]'>
            Modern day Fetch Marketplace for Scaling Partner Ecosystem
          </h2>
        ...
        <div className='mx-auto flex max-w-6xl flex-col gap-[60px]'>
          <FeatureCard
            title='Partner Interest Capture & Onboarding workflows'
            description="Market your partner program inside Sharkdom's discover marketplace which is one of its kind."
            features={[
              {
                icon: <LayoutPanelLeft size={20} />,
                text: 'Qualification Workflows'
              },
              { icon: <Link2 size={20} />, text: 'Connecting Partner program' },
              {
                icon: <Search size={20} />,
                text: 'Tracking enquiries from both ways'
              }
            ]}
          ...
          <FeatureCard
            title='Choose partners that align with your vision using Dweep AI'
            description='Forecast data to decide which partner could have better partnership success rate'
            features={[
              {
                icon: <LayoutGrid size={20} />,
                text: "Access Overlapping KPI's"
              },
              {
                icon: <Route size={20} />,
                text: 'Check partner journey for lower risk partnerships'
              }
            ]}
