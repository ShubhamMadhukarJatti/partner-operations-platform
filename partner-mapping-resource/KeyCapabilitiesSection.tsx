...
import { Bolt, CheckSquare, Hash, Lock, User } from 'lucide-react'
...
const FeatureCard = ({
  ...
  return (
    <div className='hover-scale-smooth flex flex-col gap-4 overflow-hidden rounded-[24px] bg-white p-6 shadow-sm lg:flex-row lg:items-center lg:gap-20'>
      {/* Content Side */}
      <div
        className={cn('flex-1 space-y-8 pb-4 pl-6', reverse && 'lg:order-2')}
      >
      ...
      <div className='max-w-8xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='mx-auto mb-20 max-w-5xl text-center'>
          ...
          <h2 className='mb-6 text-4xl font-semibold leading-tight text-gray-900 lg:text-[60px]'>
            Partner, scale and manage entire partnership ecosystem
          </h2>
        ...
        <div className='mx-auto flex max-w-6xl flex-col gap-[60px]'>
          ...
          <FeatureCard
            title='Be the Owner of the data being shared'
            description="Restrict your partners to access your customer's data depending on the results from partner and add group based permission to create joint email marketing programs."
            features={[
              {
                icon: <Lock size={20} />,
                text: 'Set rules to limit data visibility access'
              },
              {
                icon: <User size={20} />,
                text: 'Provide partner access based on tier'
              }
            ]}
