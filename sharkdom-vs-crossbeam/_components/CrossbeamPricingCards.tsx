...
const CROSSBEAM_ITEMS = [
  { ok: true as const, label: 'Account mapping' },
  { ok: true as const, label: 'Basic integrations' },
  { ok: false as const, label: 'No attribution' },
  { ok: false as const, label: 'No MDF tooling' }
]

const SHARKDOM_ITEMS = [
  'Everything in Crossbeam',
...
const PARTNERSTACK_ITEMS = [
  { ok: true as const, label: 'Partner payouts' },
  { ok: true as const, label: 'Affiliate tracking' },
  { ok: false as const, label: 'No account mapping' },
  { ok: false as const, label: 'Limited LMS' }
]

export default function CrossbeamPricingCards() {
  return (
    <section className='border-y border-[#e2e4eb] bg-[#f4f4ff] py-16 md:py-24'>
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        <header className='mx-auto flex max-w-4xl flex-col items-center text-center'>
          <div className='inline-flex items-center gap-2 rounded-full border border-[#d3d7e2] bg-white px-3.5 py-2 pl-3 shadow-[0px_1px_2px_rgba(14,17,27,0.04)]'>
            <span
          ...
          <p className='mt-6 max-w-xl text-pretty text-base font-normal leading-relaxed text-[#6b7280] md:max-w-[36rem] md:text-[17px] md:leading-[26px]'>
            Modeled on the Crossbeam, Partnerstack and Sharkdom published plans.
            Annual billing, 100 partners, 5 internal users.
          </p>
        </header>

        <div className='mx-auto mt-12 grid max-w-6xl gap-6 lg:grid-cols-3 lg:gap-8'>
          {/* Crossbeam */}
          <div className='compare-page-card-pop order-2 cursor-default rounded-[20px] border border-[#e2e4eb] bg-white p-7 shadow-sm hover:border-[#6863fb]/45 hover:shadow-[0px_12px_36px_-10px_rgba(96,84,236,0.35),0px_8px_24px_-12px_rgba(14,17,27,0.12)] lg:order-1'>
          ...
          {/* Sharkdom */}
          <div className='compare-page-card-pop relative order-1 cursor-default overflow-hidden rounded-[20px] border border-[#6863fb] bg-gradient-to-br from-[#6595ff] via-[#8774ff] to-[#c471ff] p-7 shadow-lg hover:shadow-[0px_24px_56px_-12px_rgba(70,60,200,0.55),0px_12px_28px_-8px_rgba(14,17,27,0.18)] lg:order-2'>
          ...
          {/* Partnerstack */}
          <div className='compare-page-card-pop order-3 cursor-default rounded-[20px] border border-[#e2e4eb] bg-white p-7 shadow-sm hover:border-[#6863fb]/45 hover:shadow-[0px_12px_36px_-10px_rgba(96,84,236,0.35),0px_8px_24px_-12px_rgba(14,17,27,0.12)]'>
            <div className='inline-block rounded-md bg-[#f6f3ee] px-4 py-1'>
              <span className='text-[13px] font-semibold text-[#0e111b]'>
                Partnerstack
              </span>
